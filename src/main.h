...
static const int LAST_POW_BLOCK = 200000; // at 60 second blocks will be about 100 years from launch
...
static const uint256 hashGenesisBlock("0x0000000f82465a72c6fd86b52fd36f0866a6a962e98e3329db8b4a24c4611d40");
...
public:
    ...
    {
        // BlackPearl: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // BlackPearl: get transaction coin age
...
public:
    ...
    // BlackPearl: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // BlackPearl: two types of block: proof-of-work or proof-of-stake
    ...
    // BlackPearl: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // BlackPearl: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // BlackPearl: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // BlackPearl: block index flags
    enum  
    {
